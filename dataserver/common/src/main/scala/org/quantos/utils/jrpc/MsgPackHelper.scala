...
object MsgPackHelper {
    ...
    def serialize(value: Any): Array[Byte] = mapper.writeValueAsBytes(value)

    def deserialize[T: Manifest](value: Array[Byte]) : T = {
        //val unpacker = org.msgpack.core.MessagePack.newDefaultUnpacker(value)
